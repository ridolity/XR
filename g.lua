...
local aa = {
    ...
    [10] = function()
        ...
        function q.Create(r)
            ...
            s.Title = p('TextLabel', {
                FontFace = Font.new('rbxasset://fonts/families/Balthazar.json', Enum.FontWeight.SemiBold,
    ...
    [11] = function()
        ...
        return function(m, n, o, p)
            ...
            q.TitleLabel = k('TextLabel', {
                FontFace = Font.new('rbxasset://fonts/families/Balthazar.json', Enum.FontWeight.Medium,
                    Enum.FontStyle.Normal),
                Text = m,
                TextColor3 = Color3.fromRGB(240, 240, 240),
                TextSize = 13,
    ...
    [13] = function()
        ...
        return function(k, l)
            ...
            m.Root = j('Frame', {
                ...
                Text = k,
                TextTransparency = 0,
                FontFace = Font.new('rbxasset://fonts/families/Balthazar.json', Enum.FontWeight.SemiBold, Enum.FontStyle.Normal),
                TextSize = 18,
                TextXAlignment = 'Left',
                TextYAlignment = 'Center',
