    ...
    [11] = function()
        ...
        return function(m, n, o, p)
            ...
            q.TitleLabel = k('TextLabel', {
                FontFace = Font.new('rbxasset://fonts/families/BuilderSansExtraBold.json', Enum.FontWeight.Medium,
                    Enum.FontStyle.Normal),
                Text = m,
                TextColor3 = Color3.fromRGB(240, 240, 240),
                TextSize = 13,
    ...
    [14] = function()
        ...
        function o.New(p, q, r, s)
            ...
            x.Frame = k('TextButton', {
                ...
                TextColor3 = Color3.fromRGB(255, 255, 255),
                TextTransparency = 0,
                FontFace = Font.new('rbxasset://fonts/families/BuilderSansExtraBold.json', Enum.FontWeight.Regular,
                    Enum.FontStyle.Normal),
                TextSize = 12,
                TextXAlignment = 'Left',
                TextYAlignment = 'Center',
