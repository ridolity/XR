...
local aa = {
    function()
        ...
        function x.ToggleTransparency(C, D)
            if x.Window then
                x.Window.AcrylicPaint.Frame.Background.BackgroundTransparency = D and 0.1 or 0
            end
        end
    ...
    [9] = function()
        ...
        return function(m, n, o)
            ...
            local p = {}
            p.Title = k('TextLabel', {
                FontFace = Font.new 'rbxasset://fonts/families/GothamBlack.json',
    ...
    [10] = function()
        ...
        function q.Create(r)
            ...
            s.Title = p('TextLabel', {
                FontFace = Font.new('rbxasset://fonts/families/GothamBlack.json', Enum.FontWeight.SemiBold,
    ...
    [11] = function()
        ...
        return function(m, n, o, p)
            ...
            q.TitleLabel = k('TextLabel', {
                FontFace = Font.new('rbxasset://fonts/families/GothamBlack.json', Enum.FontWeight.Medium,
                    Enum.FontStyle.Normal),
                Text = m,
                TextColor3 = Color3.fromRGB(240, 240, 240),
                TextSize = 13,
    ...
    [13] = function()
        ...
        return function(k, l)
            ...
            m.Root = j('Frame', {
                ...
                Text = k,
                TextTransparency = 0,
                FontFace = Font.new('rbxasset://fonts/families/GothamBlack.json', Enum.FontWeight.SemiBold, Enum.FontStyle.Normal),
                TextSize = 18,
                TextXAlignment = 'Left',
                TextYAlignment = 'Center',
    ...
    [14] = function()
        ...
        function o.New(p, q, r, s)
            ...
            x.Frame = k('TextButton', {
                ...
                TextColor3 = Color3.fromRGB(255, 255, 255),
                TextTransparency = 0,
                FontFace = Font.new('rbxasset://fonts/families/GothamBlack.json', Enum.FontWeight.Regular,
                    Enum.FontStyle.Normal),
                TextSize = 12,
                TextXAlignment = 'Left',
                TextYAlignment = 'Center',
    ...
    [53] = function()
        ...
        return {
            ...
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 25, 25), Color3.fromRGB(70, 0, 3)),
            AcrylicNoise = 0.92,
